...
const productSlice = createSlice({
    ...
    initialState: {
        veg: [
            ...
            { name: "Carrot", price: 120, image: "/VegImages/Potato.jpg" },
            { name: "Cabbage", price: 90, image: "/VegImages/Tomato.jpg" },
            { name: "Capsicum", price: 200, image: "/VegImages/Potato.jpg" },
            { name: "Onion", price: 85, image: "/VegImages/Tomato.jpg" },
            { name: "Cauliflower", price: 150, image: "/VegImages/Potato.jpg" },
            { name: "Peas", price: 130, image: "/VegImages/Tomato.jpg" },
            { name: "Brinjal", price: 95, image: "/VegImages/Potato.jpg" },
            { name: "Spinach", price: 50, image: "/VegImages/Tomato.jpg" },
            { name: "Radish", price: 80, image: "/VegImages/Potato.jpg" },
            { name: "Ginger", price: 250, image: "/VegImages/Tomato.jpg" },
            { name: "Garlic", price: 270, image: "/VegImages/Potato.jpg" },
            { name: "Pumpkin", price: 140, image: "/VegImages/Tomato.jpg" },
            { name: "Cucumber", price: 60, image: "/VegImages/Potato.jpg" },
            { name: "Bitter Gourd", price: 110, image: "/VegImages/Tomato.jpg" },
            { name: "Bottle Gourd", price: 100, image: "/VegImages/Potato.jpg" },
            { name: "Drumstick", price: 180, image: "/VegImages/Tomato.jpg" },
            { name: "Corn", price: 90, image: "/VegImages/Potato.jpg" },
            { name: "Ladyfinger", price: 175, image: "/VegImages/Tomato.jpg" }
        ],
        nonVeg: [
